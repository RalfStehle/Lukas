    ...
    DeviceCardFrame(
        ...
        CardButtonRow {
            CardButton(
                ...
                LightOrange,
                weight = 1f
            ) { CardIcon(R.drawable.baseline_horn_24, "Horn") }
            CardButton(
                onSound2,
                LightOrange,
                weight = 1f
            ) { CardIcon(R.drawable.baseline_steam_24, "Steam") }
            ...
            CardButton(onSound3, LightOrange, weight = 1f) {
                CardIcon(R.drawable.baseline_water_drop_24, "Water")
            }
            CardButton(onSound4, LightOrange, weight = 1f) {
                CardIcon(R.drawable.baseline_railway_alert_24, "Depart")
            }
        }
    }
}
